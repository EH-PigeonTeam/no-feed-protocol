...
**No Feed Protocol** is a narrative-driven sci-fi experience where communication is forbidden, and silence is survival.  
You explore, adapt, and uncover meaning in a hostile alien ecosystem through interaction, intuition, and restraint.

Developed by **Insert Coin Again**, a student-led team.
...
## Key Features
- Silent Narrative – A story told entirely without words or dialogue.
- Atmospheric World – Alien creatures, surreal plants, and interactive biomes.
- Non-verbal Interaction – Communicate and manipulate through movement, light, and rhythm.
- Collectibles and Lore – Discover hidden artifacts, symbols, and evolving alien tech.
- Custom UI/UX – Clean, immersive interface and animated interactions.
- Modular Architecture – ScriptableObject-based systems and DOTween-powered sequences.

## Gameplay
You play as a strange, non-human entity exploring a forbidden zone. Your only tools are perception and influence.

- Interact with alien structures and fauna
- Solve environmental puzzles through rhythm, distance, and mimicry
- Progress without combat, text, or HUD — only behavior and sound
...
© 2025 Insert Coin Again. All rights reserved.
